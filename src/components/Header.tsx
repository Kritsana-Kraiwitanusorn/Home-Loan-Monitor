...
export default function Header({ totalContractsCount, title, houseNumber, onSaveSettings }: HeaderProps) {
  ...
  return (
    <header className="relative w-full bg-[#fbfbfa] border border-[#c0b298] p-5 md:p-6 mb-6 shadow-sm rounded-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {isEditingTitle ? (
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-xl md:text-2xl font-bold text-[#4a3e26] font-sans border-b border-[#7d6840] bg-transparent focus:outline-none focus:border-b-2 py-0.5 max-w-[320px] sm:max-w-[450px]"
                autoFocus
              />
            ...
            <h1 
              ...
              className="group flex items-center gap-2 text-2xl md:text-3xl font-bold text-[#4a3e26] font-sans cursor-pointer hover:bg-[#ebdcb2]/20 px-2 py-1 -ml-2 rounded-sm transition-all duration-150"
        ...
        <div className="flex flex-col md:items-end justify-center gap-2">
          ...
          {/* User Profile & Logout */}
          {user && (
            <div className="flex items-center gap-3 mt-1 text-xs text-[#70644e]">
              <div className="flex items-center gap-1.5 bg-[#e8ebe0] px-2 py-1 border border-[#e6e4d5] rounded-sm">
                {user.photoURL ? (
